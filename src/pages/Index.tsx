        ...
        <div className="section-inner">
          ...
          <div className="services-grid">
            ...
            {[
              ...
              { emoji: "🗼", title: "Маяк Назимова — место с историей", desc: "На краю косы с 1886 года горели костры, чтобы предупреждать корабли об опасности. В 1910 году здесь возвели маяк высотой 5,4 м — один из первых на Дальнем Востоке. Назван в честь вице-адмирала Павла Назимова, командующего Тихоокеанской эскадрой." },
