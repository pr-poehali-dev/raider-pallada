      ...
      <section className="section pain">
        <div className="section-inner">
          ...
          <div className="pain-items">
            {[
              { icon: "🌊", title: "Море — таким, каким вы его помните из детства", desc: "Чистое, тёплое, без суеты. Просто вода, песок и время, которое никуда не торопится." },
              { icon: "🔥", title: "Самый честный морепродукт — тот, что достал сам", desc: "Спизула из бухты прямо на мангал. Никаких заморозок, никаких посредников — только море и огонь." },
              { icon: "🌿", title: "Хочется настоящей тишины?", desc: "Коса Назимова — звук волн, солёный бриз и звёздное небо без городской засветки. Здесь тишина и море не фон — они главные." },
            ].map((item) => (
        ...
        <div className="section-inner">
          ...
          <div className="services-grid">
            ...
            {[
              ...
              { emoji: "🌸", title: "Лотосы рядом с косой Назимова", desc: "Природный парк «Хасанский» — озеро с цветущими лотосами и цаплями. Цветение — начало августа. К лотосам можно подплыть на лодках. И главное — до косы Назимова отсюда рукой подать." },
              { emoji: "🗼", title: "Маяк Назимова — место с историей", desc: "На краю косы с 1886 года горели костры, чтобы предупреждать корабли об опасности. В 1910 году здесь возвели маяк высотой 5,4 м — один из первых на Дальнем Востоке. Он был оборудован сигнальным колоколом для подачи звуковых сигналов в тумане. В 1956 году колокол сменила автоматическая звукосигнальная установка. Назван в честь вице-адмирала Павла Назимова, командующего Тихоокеанской эскадрой." },
      ...
      <section className="section day" id="day">
        <div className="section-inner">
          ...
          <div className="timeline">
            {[
              { time: "06:30", icon: "🚶", title: "Утренняя прогулка по берегу", desc: "Тихий час до завтрака. Мокрый песок под ногами, крики чаек, запах водорослей — море только просыпается вместе с вами." },
              { time: "07:00", icon: "☕", title: "Рассвет над морем", desc: "Открываете дверь домика — море в 50 метрах. Кофе на веранде, звук волн, никаких будильников." },
              { time: "08:30", icon: "🌊", title: "Первое купание", desc: "Тёплая вода, чистый пляж — только ваши гости." },
              { time: "12:00", icon: "🏖️", title: "Прогулка по прибрежной тропе", desc: "Коса уходит в море — и вы идёте за ней. Песок, волны с обеих сторон, солёный бриз. 20 минут — и вы на краю земли." },
              { time: "13:00", icon: "🤿", title: "Снорклинг", desc: "Маска, трубка — и дно бухты как на ладони. Нашли спизулу — накопали к обеду. Открыли на углях, выжали лимон. Ни один ресторан не даст вам такого вкуса." },
              { time: "15:30", icon: "🏐", title: "Волейбол или бадминтон на пляже", desc: "Сетка на песке, команда из своих. Самый простой способ разогнать кровь после сытного обеда." },
              { time: "16:30", icon: "🎲", title: "Кино или настолки на веранде", desc: "Гамак, настольные игры для компании или фильм под звук моря. Для тех, кто хочет просто отдохнуть без движения." },
              { time: "17:30", icon: "⛵", title: "Прогулка на катере по бухте", desc: "Часовой выход в море: ветер, брызги, виды на базу с воды. Можно искупаться прямо с борта на глубине." },
